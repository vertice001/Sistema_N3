...
$rs = mysql_query("Select * from jugadores where rut = '$vaRut'",$cnn);
	...
	if ($row= mysql_fetch_array($rs)){
		...
		$muestroPosicion= $row['posicion'];
		$muestroNacionalidad= $row['nacionalidad'];
		$muestroRut= $row['rut'];
	}
    ...
    <td colspan="3"><table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <table width="450" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td colspan="2"><div align="center"><span class="Estilo4">Jugadores</span></div></td>
              </tr>
              <tr>
                <td width="153" class="Estilo3"><strong>I</strong>ngresar rut: </td>
                <td width="297"><input name="cajaRut" type="text" id="cajaRut" />
                  <label>
              ...
              <tr>
                ...
                <td><span class="Estilo3"><strong>
                  <label>
                  <a href="adminJugadores2.html"></a></label>
                  <label>
                  <script language="JavaScript" type="text/javascript">

function AbreVentana() {
  window.open("mniJugadores.php", "_blank", "toolbar=no,menubar=no,directories=no,status=no,resizable=no,location=no,scrollbars=no,height=350,width=410,screenX=400,screenY=120")
}
                  </script>
                  </label>
                </strong></span></td></tr>
              ...
              <tr>
                ...
                <td><label>
                  <input name="cajaEquipo" type="text" id="cajaEquipo" value=<?php echo $muestroEquipo; ?> >
                </label></td>
              </tr>
              <tr>
                <td class="Estilo3">Posicion:</td>
                <td><label>
                  <input name="cajaPosicion" type="text" id="cajaPosicion" value=<?php echo $muestroPosicion; ?> >
                </label></td>
              </tr>
              <tr>
                <td class="Estilo3">Nacionalidad:</td>
                <td><label>
                  <input name="cajaNacionalidad" type="text" id="cajaNacionalidad" value=<?php echo $muestroNacionalidad; ?> >
                </label></td>
              </tr>
              <tr>
            ...
            <table width="118" border="0" align="center" cellspacing="2">
              <tr>
                <td>Listar jugadores</td>
              </tr>
              <tr>
                <td><a href="ListarJugadores.php" target="_blank"><img src="verPDF.jpg" width="77" height="75" /></a></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </td>
...
<?php
  ...
  $vaNacionalidad    = $_POST['cajaNacionalidad'];
  
  
  $sql   = "Update jugadores set nombre ='$vaNombre', apellido ='$vaApellidos', rut ='$vaRUT', fecha_nac ='$vaFecha', equipo ='$vaEquipo', posicion ='$vaPosicion', nacionalidad ='$vaNacionalidad' where  rut ='$vaRuT'";
  mysql_query ($sql, $cnn);  
  ?>
...
$cnn=Conectar();
$vaRuT=$_POST['coRut'];
$sql= "delete from jugadores where rut = '$vaRuT'";
