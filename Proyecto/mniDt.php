...
<form id="form1" name="form1" method="post" action="">
  <table width="282" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2"><div align="center" class="Estilo3">Agregar Dt </div></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
...
if($_POST['btAgregar']=="Agregar"){
	...
	$vaHora=$_POST['cajaNombre'];
	$vaEstadio=$_POST['cajaApellido'];
	$vaArbitro=$_POST['cajaRut'];
	$vaLocal=$_POST['cajaEquipo'];
	
	$sql= "insert into dt values
('','$vaHora','$vaEstadio','$vaArbitro','$vaLocal','$vaFecha')";
