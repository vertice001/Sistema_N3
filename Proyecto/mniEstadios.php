...
<form id="form1" name="form1" method="post" action="">
  <table width="282" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2"><div align="center" class="Estilo3">Agregar Estadio </div></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td height="35" class="Estilo4">Ubicacion</td>
      <td height="35"><span class="Estilo4">:</span><span class="Estilo3">
        <label>
        <input name="cajaUbicacion" type="text" id="cajaUbicacion" size="16" />
        </label>
       
      </span></td>
    </tr>
    <tr>
      <td height="29" class="Estilo4">Capacidad</td>
      <td><label> :
        <input name="cajaCapacidad" type="text" id="cajaCapacidad" size="16" />
      </label></td>
    </tr>
    <tr>
...
if($_POST['btAgregar']=="Agregar"){
	...
	$sql= "insert into estadios values
