...
$rs = mysql_query("Select * from presidentes where rut = '$vaRut'",$cnn);
      ...
      <table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="510"><table width="450" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td colspan="2"><div align="center"><span class="Estilo4">Presidentes</span></div></td>
              </tr>
              <tr>
                <td width="174" class="Estilo3"><strong>I</strong>ngresar Rut </td>
                <td width="276"><input name="cajaRut" type="text" id="cajaRut" />
              ...
              <tr>
                ...
                <td><span class="Estilo3"><strong>
                  <label>
                    <a href="adminPresi2.html"></a></label>
                  <label>
                    <script language="JavaScript" type="text/javascript">

function AbreVentana() {
  window.open("mniPresi.php", "_blank", "toolbar=no,menubar=no,directories=no,status=no,resizable=no,location=no,scrollbars=no,height=300,width=410,screenX=400,screenY=120")
}
                  </script>
                    </label>
                </strong></span></td></tr>
            ...
            <table width="150" border="0" align="center" cellspacing="2">
              <tr>
                <td width="140">Listado presidentes</td>
              </tr>
              <tr>
                <td><a href="ListarPresidentes.php" target="_blank"><img src="verPDF.jpg" width="77" height="75" /></a></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            </td>
...
<?php
  ...
  $sql   = "Update presidentes set nombre ='$vaNombre', apellido ='$vaApellidos', rut ='$vaRUT', fecha_nac ='$vaFecha', equipo ='$vaEquipo' where  rut ='$vaRuT'";
  mysql_query ($sql, $cnn);  
  ?>
...
$cnn=Conectar();
$vaRuT=$_POST['coRut'];
$sql= "delete from presidentes where  rut ='$vaRuT'";
