      ...
      <table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="510"><table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="Estilo3">Para recibir promociones y descuentos ingrese su <strong><em>Correo Electronico . </em></strong></span></td>
            </tr>
            <tr>
              <td><label>
                <input name="textfield" type="text" size="15" maxlength="11" />
                <span class="Estilo3">@</span>
                <input name="textfield2" type="text" size="10" maxlength="8" />
            ...
            <tr>
              <td><span class="Estilo3">...o unase a la <a href="http://zona.entel.cl/descuentos/futbol/colo-colo-santiago/" target="_blank" class="Estilo4">ZONA ENTEL</a> y obtenga beneficios en entradas 2x1 a partidos del campeonato nacional. </span></td>
            </tr>
          </table></td>
        </tr>
      </table>
